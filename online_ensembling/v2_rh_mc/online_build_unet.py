...
#---------------------------------------f------------------------------------------------------------
# MMF_NN_EMULATOR
f_torch_model = '/pscratch/sd/k/kfrields/hugging/E3SM-MMF_saved_models/diffusion_models/model_wrapping_test/wrapped_unet_model.pt'
